...
# User input
user_input = st.text_input("Type a keyword(e.g., biryani) from the following options: [Mutter Rice, Tahari, Khichdi with Kheema, Chicken Shawarma, Qurbani ka Meetha, Sheer Khurma, Fruit Custard, Kunafa, Kaddu ki Kheer, Hyderabadi Mandi, Malai Kofta, Chicken 65, Fish Fry, Shahi Paneer, Chicken Shami Kebab, Mixed Vegetable Curry, Chicken Pickle, Mango Pickle, Tomato Pickle, Biryani]:").strip()
